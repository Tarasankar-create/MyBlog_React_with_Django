...
function Contents() {
  ...
  return (
    <div className='p-5'>
      ...
      {(!email) ? (<div className='w-full mt-20 mb-112'>
        <p className='text-[rgb(35,35,35)] text-center font-mono text-6xl'>Please login to view your blogs</p>
      </div>) :
      (blog.length===0)?(<div className='w-full mt-20 mb-112'>
        <p className='text-[rgb(35,35,35)] text-center font-mono text-6xl'>No blogs found</p>
      </div>) :
        (blog.map((v, i) => (
          <div key={v['title']} className='relative p-6 border-1 border-black mt-5'>
            ...
            <div className=' border-2 border-gray-300 px-5 my-5 text-black'>
              <div className='flex border-0 mb-2 py-2 border-black shadow-lg justify-between'>
